(self["webpackChunkjacdac_docs"] = self["webpackChunkjacdac_docs"] || []).push([[3196,4659],{
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(3838);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(77750);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(94659);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(42440);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(70576);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(88979);
...
/* harmony import */ var _hooks_useKeyboardNavigationProps__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(82312);
...
/* harmony import */ var _translations__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(27761);
/* eslint-disable jsx-a11y/no-autofocus */var miniSearchOptions={fields:["name","description"],searchOptions:{fuzzy:true,prefix:true,boost:{name:5,description:1}}};var serviceProviderDefinitionsCache=null;function uniqueServiceProviderDefinitionsFromCatalog(bus){if(serviceProviderDefinitionsCache)return serviceProviderDefinitionsCache;var seen=[];var deviceSpecs=bus.deviceCatalog.specifications();var _loop=function _loop(devSpec){// find a matching service provider definition 
// that contains all the services in the devSpec
var matchingProviders=(0,_jacdac_ts_src_servers_servers__WEBPACK_IMPORTED_MODULE_1__/* .serviceProviderDefinitions */ .a3)().filter(sp=>{var _devSpec$tags,_devSpec$services,_devSpec$services2;return!((_devSpec$tags=devSpec.tags)!==null&&_devSpec$tags!==void 0&&_devSpec$tags.includes("brain"))&&(devSpec.hardwareTags?devSpec.hardwareTags.includes(sp.name):true)&&((_devSpec$services=devSpec.services)===null||_devSpec$services===void 0?void 0:_devSpec$services.length)===sp.services().length&&((_devSpec$services2=devSpec.services)===null||_devSpec$services2===void 0?void 0:_devSpec$services2.every(svc=>sp.serviceClasses.includes(svc)))&&sp.serviceClasses.every(sc=>{var _devSpec$services3;return(_devSpec$services3=devSpec.services)===null||_devSpec$services3===void 0?void 0:_devSpec$services3.includes(sc);});});for(var provider of matchingProviders){if(!seen.includes(provider)){seen.push(provider);}}};for(var devSpec of deviceSpecs){_loop(devSpec);}serviceProviderDefinitionsCache=seen;return seen;}function StartSimulatorDialog(props){var{open,onClose,sensor}=props;var bus=(0,_jacdac_useBus__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z)();var{enqueueSnackbar}=(0,_hooks_useSnackbar__WEBPACK_IMPORTED_MODULE_10__/* ["default"] */ .Z)();var{addHostedSimulator}=(0,_HostedSimulatorsContext__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .ZP)();var{trackEvent}=(0,_hooks_useAnalytics__WEBPACK_IMPORTED_MODULE_6__/* ["default"] */ .ZP)();var{mobile}=(0,_hooks_useMediaQueries__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)();var searchId=(0,react__WEBPACK_IMPORTED_MODULE_0__.useId)();var{0:query,1:setQuery}=(0,react__WEBPACK_IMPORTED_MODULE_0__.useState)("");var deviceHostDialogId=searchId+"-devhostdialog";var deviceHostLabelId=searchId+"-devhostlabel";var contentRef=(0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)();var documents=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>(0,_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .Z)(uniqueServiceProviderDefinitionsFromCatalog(bus).filter(server=>!sensor||server.serviceClasses.some(sc=>(0,_jacdac_ts_src_jdom_spec__WEBPACK_IMPORTED_MODULE_8__/* .isSensor */ .rq)((0,_jacdac_ts_src_jdom_spec__WEBPACK_IMPORTED_MODULE_8__/* .serviceSpecificationFromClassIdentifier */ .d5)(sc)))).map(server=>({id:"server:"+server.name,name:server.name,description:server.serviceClasses.map(_jacdac_ts_src_jdom_spec__WEBPACK_IMPORTED_MODULE_8__/* .serviceSpecificationFromClassIdentifier */ .d5).map(spec=>spec.name+" "+spec.shortName+" "+spec.notes["short"]).join(", "),server}))),[sensor]);var{search,searchResults}=(0,react_minisearch__WEBPACK_IMPORTED_MODULE_7__.useMiniSearch)(documents,miniSearchOptions);var handleSearchChange=event=>setQuery(event.target.value);var handleProviderDefinition=provider=>()=>{trackEvent("dashboard.server.start",{server:provider.name});(0,_jacdac_ts_src_servers_servers__WEBPACK_IMPORTED_MODULE_1__/* .addServiceProvider */ .Q6)(bus,provider);onClose();};var handleHostedSimulator=simulator=>()=>{trackEvent("dashboard.sim.start",{simulator:simulator.name});addHostedSimulator(simulator);onClose();};var handleAddAll=/*#__PURE__*/function(){var _ref=(0,_babel_runtime_helpers_esm_asyncToGenerator__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z)(function*(){var allProviderDefinitions=(0,_jacdac_ts_src_jdom_utils__WEBPACK_IMPORTED_MODULE_3__/* .uniqueMap */ .EM)((0,_jacdac_ts_src_servers_servers__WEBPACK_IMPORTED_MODULE_1__/* .serviceProviderDefinitions */ .a3)().filter(hd=>hd.serviceClasses.length===1),hd=>hd.serviceClasses[0].toString(),h=>h);enqueueSnackbar("starting "+allProviderDefinitions.length+" simulators...","info");onClose();for(var provider of allProviderDefinitions){yield (0,_jacdac_ts_src_jdom_utils__WEBPACK_IMPORTED_MODULE_3__/* .delay */ .gw)(100);(0,_jacdac_ts_src_servers_servers__WEBPACK_IMPORTED_MODULE_1__/* .addServiceProvider */ .Q6)(bus,provider);}});return function handleAddAll(){return _ref.apply(this,arguments);};}();var keyboardProps=(0,_hooks_useKeyboardNavigationProps__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z)(contentRef.current,true);// delay query
(0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(()=>{(0,react__WEBPACK_IMPORTED_MODULE_0__.startTransition)(()=>{search===null||search===void 0?void 0:search(query);});},[query]);var results=(!query?documents:searchResults)||documents;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .Z,{id:deviceHostDialogId,"aria-labelledby":deviceHostLabelId,open:open,onClose:onClose,fullWidth:true,fullScreen:mobile,scroll:"paper"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ui_DialogTitleWithClose__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z,{onClose:onClose,id:deviceHostLabelId},(0,_translations__WEBPACK_IMPORTED_MODULE_12__/* .translateLang */ .L)("startAsimulator")),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Z,{ref:contentRef},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z,Object.assign({tabIndex:0,id:searchId,sx:{mt:"8px"},label:(0,_translations__WEBPACK_IMPORTED_MODULE_12__/* .translateLang */ .L)("filterSimulators"),inputProps:{"aria-label":"Filter textbox for simulators"},type:"search",fullWidth:true,size:"small",autoFocus:true,value:query,onChange:handleSearchChange,autoComplete:"off"},keyboardProps)),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .Z,{sx:{height:mobile?undefined:"min(32rem, 80vh)"}},results.map(_ref2=>{var{id,name,server,simulator}=_ref2;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_20__/* ["default"] */ .ZP,Object.assign({button:true,key:id,onClick:server?handleProviderDefinition(server):handleHostedSimulator(simulator)},keyboardProps),(0,_translations__WEBPACK_IMPORTED_MODULE_12__/* .translateServer */ .Q)(name));}))),_jacdac_ts_src_jdom_flags__WEBPACK_IMPORTED_MODULE_2__/* .Flags.diagnostics */ .v.diagnostics&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_21__/* ["default"] */ .Z,null,_jacdac_ts_src_jdom_flags__WEBPACK_IMPORTED_MODULE_2__/* .Flags.diagnostics */ .v.diagnostics&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__.createElement(_mui_material__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .Z,{variant:"outlined",onClick:handleAddAll},"start all simulators")));}
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "L": function() { return /* binding */ translateLang; },
/* harmony export */   "Q": function() { return /* binding */ translateServer; }
/* harmony export */ });
var translations={en:{simulators:"Simulators",devices:"Devices",autoStart:"Auto start",startSimulator:"Start simulator",startAsimulator:"Start a simulator",clearSimulators:"clear simulators",filterSimulators:"filter simulators",blockAdd:"Add blocks",blockEnabled:"Add blocks for your connected and simulated devices to the modules drawer",blockDisabled:"This button becomes available if you have devices connected that don't have their matching blocks added to the 'Modules' drawer",simAdd:"Add simulators",simEnabled:"Create a simulator for each Role without an assigned device",simDisabled:"This button becomes available if there are Roles without assignable devices"},de:{simulators:"Simulatoren",devices:"Geräte",autoStart:"Automatisch starten",startSimulator:"Simulator starten",startAsimulator:"Einen Simulator starten",clearSimulators:"Simulatoren löschen",filterSimulators:"Simulatoren filtern",blockAdd:"Blöcke hinzufügen",blockEnabled:"Fügen Sie Blöcke für Ihre verbundenen und simulierten Geräte zur Modulauswahl hinzu",blockDisabled:"Diese Schaltfläche wird verfügbar, wenn Sie Geräte verbunden haben, für die noch keine passenden Blöcke zur 'Module'-Leiste hinzugefügt wurden",simAdd:"Simulatoren hinzufügen",simEnabled:"Erstellen Sie einen Simulator für jede Rolle ohne zugewiesenes Gerät",simDisabled:"Diese Schaltfläche wird verfügbar, wenn es Rollen ohne zuweisbare Geräte gibt"}};function translateLang(key){var _translations$lang;var lang=typeof navigator!=="undefined"?navigator.language.slice(0,2):"en";return((_translations$lang=translations[lang])===null||_translations$lang===void 0?void 0:_translations$lang[key])||translations.en[key];}var translate_servers={de:{"accelerometer":"Beschleunigungssensor","humidity + temperature":"Feuchtigkeit + Temperatur","vibration motor":"Vibrationsmotor","button":"Knopf","light level (solar)":"Lichtstärke (solar)","magnetic field level":"Magnetfeldstärke","power":"Stromversorgung","relay (EM/10A)":"Relais (EM/10A)","water pump (relay)":"Wasserpumpe (Relais)","LED ring 8 pixels":"LED-Ring 8 Pixel","LED pixel strip 30":"LED-Pixelstreifen 30","LED pixel strip 60":"LED-Pixelstreifen 60","LED pixel strip 150":"LED-Pixelstreifen 150","LED pixel strip 300":"LED-Pixelstreifen 300","rotary encoder + button":"Drehgeber + Knopf","servo":"Servo","servo (270°)":"Servo (270°)","servo (360°)":"Servo (360°)","servo (continuous)":"Servo (kontinuierlich)","rotary potentiometer":"Drehpotentiometer","slider (potentiometer)":"Schieberegler (Potentiometer)","Hall sensor (potentiometer)":"Hallsensor (Potentiometer)","distance (sonar)":"Entfernung (Sonar)","DC current/voltage measurement":"Gleichstrom-/Spannungsmessung","light bulb":"Glühbirne","line sensor (3x digital)":"Liniensensor (3x digital)","soil moisture":"Bodenfeuchtigkeit","water acidity (pH)":"Wasser-Säuregehalt (pH)","thermometer (outdoor)":"Thermometer (außen)","thermometer (indoor)":"Thermometer (innen)","thermometer (medical)":"Thermometer (medizinisch)","buzzer":"Summer","motion":"Bewegung","UV index":"UV-Index"}};function translateServer(name){var lang=typeof navigator!=="undefined"?navigator.language.slice(0,2):"en";if(lang==="en")return name;if(translate_servers[lang]){return translate_servers[lang][name]||name;}return name;}
...
//# sourceMappingURL=3196-b4fbef08174c1c38b048.js.map